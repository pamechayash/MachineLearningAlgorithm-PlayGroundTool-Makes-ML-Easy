...
export default function LassoReg(){
...
<button className="btn-two" onClick={getGraphLem}>Alpha parameters Tuning</button>

</div>
</div>

<div ref={ref1} className="graph" style={{width:"100vw"}}>
